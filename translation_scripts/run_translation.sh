...
# MTBench Dataset Translation Runner Script
# This script helps you run the translation with proper environment setup

set -e  # Exit on any error

echo "🚀 MTBench Dataset Translation Runner"
echo "====================================="

# Check if required files exist
if [ ! -f "translate_mtbench_dataset.py" ]; then
    echo "❌ Error: translate_mtbench_dataset.py not found!"
...
# Default values
INPUT_FILE="../generated_datasets/mtbench_hard_training.jsonl"
OUTPUT_FILE="../generated_datasets/mtbench_hard_training_english.jsonl"
BATCH_SIZE=200
MAX_CONCURRENT=50
...
echo "   Progress will be logged to mtbench_translation.log"
echo "   Checkpoints will be saved regularly."
echo ""

# Run the translation
python3 translate_mtbench_dataset.py \
    --input "$INPUT_FILE" \
    --output "$OUTPUT_FILE" \
...
echo "📋 Check mtbench_translation.log for detailed information"
